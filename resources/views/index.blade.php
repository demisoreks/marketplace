                ...
                <div class="carousel-item @if ($count == 0) active @endif">
                    <div class="row" style="background-image: linear-gradient(#{{ $site->getConfiguration()->colour1 }}, #eee); padding: 100px 0;">
                        <div class="col-lg-5 offset-lg-1 text-center text-lg-left" style="color: #fff;">
                            ...
                            <a href="#" class="btn btn-lg" style="background-color: transparent; color: #fff; border: 1px solid #fff; border-radius: 0;">Buy Now</a>
                        </div>
                        <div class="col-lg-6">
    ...
    <div class="col-lg-10 offset-lg-1">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-xl-3" style="margin-bottom: 20px;">
                <div class="card" style="border: none; border-radius: 15px; box-shadow: none;">
                    <div class="card-body text-center" style="padding: 20px 0;">
                        {{ Html::image($featured_product->logo_url, $featured_product->name, ['height' => '100px']) }}
                    </div>
                    <div class="card-footer" style="background: none; padding-left: 0; padding-right: 0;">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <a class="input-group-text" id="{{ 'product'.$featured_product->id }}" style="border-radius: 0; background-color: #{{ $site->getConfiguration()->colour1 }}; border: 1px solid #{{ $site->getConfiguration()->colour1 }}; color: #fff;" href="#">BUY NOW</a>
                        </div>
                    </div>
                </div>
            </div>
