...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-sm" href="{{ route('products.index') }}" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-arrow-left"></i> Back to List of Products</a>
        @if ($product->active)
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" href="{{ route('products.edit', [$product->slug()]) }}" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-edit"></i> Edit</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 400px; overflow-y: scroll;">
                <table class="table table-striped table-hover">
                    ...
                    <tr class="row">
                        <td class="col-md-3">Featured</td>
                        <td class="col-md-9">@if ($product->featured) Yes @else No @endif</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Vendor</td>
                        <td class="col-md-9">{{ $product->vendor->name }}</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Logo</td>
                        <td class="col-md-9">@if ($product->logo_url) {{ Html::image($product->logo_url, 'Logo', ['height' => '50px']) }} @endif</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Image</td>
                        <td class="col-md-9">@if ($product->image_url) {{ Html::image($product->image_url, 'Image', ['height' => '100px']) }} @endif</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Summary</td>
                        <td class="col-md-9">{!! nl2br($product->summary) !!}</td>
                    </tr>
                    <tr class="row">
                        <td class="col-md-3">Details</td>
                        <td class="col-md-9">{!! $product->details !!}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" data-toggle="modal" data-target="#modal1" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td width="10%">
                            <form method="POST" action="{{ route('products.product_categories.destroy', [$product->slug(), $product_category->slug()]) }}">
                                {{ csrf_field() }}
                                {{ method_field('delete') }}
                                <button class="btn btn-sm btn-danger" type="submit" title="Delete" onclick="return confirmDelete()"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                    @endforeach
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" data-toggle="modal" data-target="#modal2" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 156px; overflow-y: scroll;">
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" data-toggle="modal" data-target="#modal3" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 400px; overflow-y: scroll;">
                ...
                <table class="table table-striped table-hover" width="100%">
                    ...
                    <tr>
                        <td @if ($product_feature->highlight) class="font-weight-bold" @endif>{{ $product_feature->feature }}</td>
                        <td width="10%">
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" data-toggle="modal" data-target="#modal4" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 156px; overflow-y: scroll;">
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" data-toggle="modal" data-target="#modal5" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 156px; overflow-y: scroll;">
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" href="{{ route('products.product_plans.create', [$product->slug()]) }}" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
        ...
        <div class="card" style="margin-bottom: 20px;">
            <div class="card-header font-weight-bold">
                <div class="row" style="display: flex; align-items: center;">
                    ...
                    <div class="col-6 text-right"><a class="btn btn-sm" href="#" style="background-color: #{{ json_decode(Cookie::get('configuration'))->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> Add</a></div>
                </div>
            </div>
            <div class="card-body" style="height: 250px; overflow-y: scroll;">
