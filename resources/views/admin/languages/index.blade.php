...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-sm" href="{{ route('languages.create') }}" style="background-color: #{{ $site->getConfiguration()->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> New Language</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a title="Edit" href="{{ route('languages.edit', [$language->slug()]) }}" style="color: #{{ $site->getConfiguration()->colour1 }};"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                        ...
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped responsive" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $language->name }}</td>
                                    <td class="text-center">
                                        <a title="Enable" href="{{ route('languages.enable', [$language->slug()]) }}" style="color: #{{ $site->getConfiguration()->colour1 }};"><i class="fas fa-undo"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
