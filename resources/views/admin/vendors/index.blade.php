...
<div class="row">
    <div class="col-12" style="margin-bottom: 20px;">
        <a class="btn btn-sm" href="{{ route('vendors.create') }}" style="background-color: #{{ $site->getConfiguration()->colour1 }}; color: #fff;"><i class="fas fa-plus"></i> New Vendor</a>
    </div>
</div>
<div class="row">
    <div class="col-12">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a title="Edit" href="{{ route('vendors.edit', [$vendor->slug()]) }}" style="color: #{{ $site->getConfiguration()->colour1 }};"><i class="fas fa-edit"></i></a>&nbsp;&nbsp;
                ...
                <div id="collapse32" class="collapse" aria-labelledby="heading32" data-parent="#accordion2">
                    <div class="card-body">
                        <table id="myTable2" class="display-1 table table-condensed table-hover table-striped responsive" width="100%">
                            ...
                            <tbody>
                                @foreach ($disabled_vendors as $vendor)
                                <tr>
                                    <td>{{ $vendor->name }}</td>
                                    <td class="text-center">
                                        <a title="Enable" href="{{ route('vendors.enable', [$vendor->slug()]) }}" style="color: #{{ $site->getConfiguration()->colour1 }};"><i class="fas fa-undo"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
